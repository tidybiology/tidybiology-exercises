---
title: "Advanced Dplyr Exercises"
...
Divide each numeric variable by the sum of all the numeric variables for each row. Multiply all these values by 100. Save the output data frame as `happy_100` and confirm that the row sums of numeric variables in this data frame all equal 100
